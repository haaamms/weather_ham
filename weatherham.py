# -*- coding: utf-8 -*-
"""
Created on Sun May 14 09:31:18 2023
...
#     print(f'The current temperature at {lat},{long} is {temp} °F.')
# 
# else:
...
def refresh_weather():
    fetch_weather()  # Call existing weather function
    window.after(3600000, refresh_weather)  # Schedule next refresh
